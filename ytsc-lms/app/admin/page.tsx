    ...
    <div className="admin-dashboard">
      ...
      <div className="admin-stats-grid">
        <div className="admin-stat-card">
          ...
          <Link href="/admin/courses" className="stat-link">View All →</Link>
        </div>
        ...
        <div className="admin-stat-card">
          ...
          <Link href="/admin/users" className="stat-link">View All →</Link>
        </div>
      ...
      <div className="admin-quick-actions">
        ...
        <div className="quick-actions-grid">
          <Link href="/admin/courses/new" className="quick-action-card">
          ...
          <Link href="/admin/analytics/export" className="quick-action-card">
            <span className="action-icon">📥</span>
            <h3>Export Data</h3>
      ...
      <div className="admin-recent-section">
        <div className="recent-column">
              ...
              recentCourses.map((course: Course) => (
                <div key={course.id} className="recent-item">
                  ...
                  <div className="recent-item-actions">
                    <Link href={`/admin/courses/${course.id}/edit`} className="action-btn edit">✏️</Link>
                    <Link href={`/courses/${course.id}`} className="action-btn view">👁️</Link>
                  </div>
                </div>
              ))
            ) : (
          ...
          <Link href="/admin/courses" className="view-all-link">View All Courses →</Link>
        </div>
        ...
        <div className="recent-column">
            ...
            {recentUsers && recentUsers.length > 0 ? (
              recentUsers.map((user: Profile) => (
                <div key={user.id} className="recent-item">
                  ...
                  <div className="recent-item-actions">
                    <Link href={`/admin/users/${user.id}`} className="action-btn view">👁️</Link>
                    <Link href={`/admin/users/${user.id}/edit`} className="action-btn edit">✏️</Link>
                  </div>
                </div>
              ))
            ) : (
          ...
          <Link href="/admin/users" className="view-all-link">View All Users →</Link>
        </div>
      </div>
    </div>
  )
