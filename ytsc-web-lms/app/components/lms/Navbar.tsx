...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    // Add proper types to the callback parameters
    ...
    <nav className="navbar">
      <div className="container nav-container">
        ...
        <div className="nav-links desktop-nav">
          ...
          <Link href="/lms/dashboard" className={`nav-link ${isActive('/lms/dashboard') ? 'active' : ''}`}>
            Dashboard
          </Link>
        ...
        {isMenuOpen && (
          <div className="mobile-nav">
            ...
            <Link href="/lms/dashboard" className="mobile-nav-link" onClick={() => setIsMenuOpen(false)}>
              Dashboard
            </Link>
